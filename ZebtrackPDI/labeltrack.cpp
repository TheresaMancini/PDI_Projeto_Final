...
//      char tipo=((ZebtrackPDI*)(parent()->parent()))->area;
//      if(tipo=='i'){
//          interpen.setWidth(2);
...
//      }
//      if(((ZebtrackPDI*)(parent()->parent()))->areas_exclus.size()!=0||((ZebtrackPDI*)(parent()->parent()))->areas_inter.size()!=0
//              ||((ZebtrackPDI*)(parent()->parent()))->process.empty()==false){
//          for (int i=0;i<((ZebtrackPDI*)(parent()->parent()))->areas_inter.size();i++){
//              painter.setPen(interpen);
//              painter.drawPolygon(((ZebtrackPDI*)(parent()->parent()))->areas_inter[i]);
//          }
//          for (int i=0;i<((ZebtrackPDI*)(parent()->parent()))->areas_exclus.size();i++){
//              painter.setPen(excluspen);
//              painter.drawPolygon(((ZebtrackPDI*)(parent()->parent()))->areas_exclus[i]);
//          }
//          painter.setPen(processpen);
//          painter.drawPolygon(((ZebtrackPDI*)(parent()->parent()))->process);
//      }
